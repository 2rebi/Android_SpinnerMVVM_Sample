...
import io.github.rebirthlee.spinnermvvm.java.databinding.ActivityMainBinding;
import io.github.rebirthlee.spinnermvvm.java.databinding.ItemViewBinding;
...
public class MainActivity extends AppCompatActivity implements OnClickListener<Person> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleSpinnerAdapter(this, R.layout.item_view, BR.viewModel, items);
